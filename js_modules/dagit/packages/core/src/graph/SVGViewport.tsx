...
const SVGViewportStyles: React.CSSProperties = {
  ...
  userSelect: 'none',
  outline: 'none',
  background: `url("data:image/svg+xml;utf8,<svg width='30px' height='30px' viewBox='0 0 80 80' xmlns='http://www.w3.org/2000/svg'><circle fill='rgba(239, 239, 239, 1)' cx='5' cy='5' r='5' /></svg>") repeat`,
};
